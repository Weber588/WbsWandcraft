...
@NullMarked
public class WandGenerator implements Keyed, ItemGenerator {
    ...
    public ItemStack generateItem() {
        ...
        Wand wand = Objects.requireNonNull(Wand.fromItem(wandItem));
        ...
        if (!modifierGenerators.isEmpty()) {
            ...
            for (int i = 0; i < modifiers; i++) {
                ...
                wand.setModifier(modifierGenerator.generate());
            }
        }
        ...
        if (!spellGenerators.isEmpty()) {
            ...
            if (wand instanceof WizardryWand wizardryWand) {
                ...
                for (int i = 0; i < spells; i++) {
                    ...
                    SpellInstance instance = spellGenerator.generate();
